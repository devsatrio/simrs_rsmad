"""
Django settings for simrs_rsmad project.
...
SECRET_KEY = 'django-insecure-o8(owg#%@)ux0^no+)fv0inj*r+-m1beb+c0li3+h@1^3pykbo'
...
WSGI_APPLICATION = 'simrs_rsmad.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    #"search_model": ["pasien.pasien", "auth.Group"],
